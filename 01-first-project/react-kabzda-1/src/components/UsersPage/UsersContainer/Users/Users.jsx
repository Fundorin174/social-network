                        ...
                        this
                            ...
                            .map(user => {
                                if (`${user.name}`.toLowerCase().includes(this.props.searchUsersText.toLowerCase())) {
                                    return <User key={user.id} id={user.id} fullName={user.name} follow={user.followed}
                                                 smallPhotoSrc={user.photos.small}
                                        // country={user.residency.country}

                                        // city={user.residency.city}
                                                 status={user.status} isFrend={user.isFrend} toFollow={this.props.toFollow}
                                                 toUnfollow={this.props.toUnfollow} toFriends={this.props.toFriends}
