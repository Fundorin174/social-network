...
type ToDoListContainerMapDispatchPropsType = {
  ...
  loadNewTask: (newTask: any, listId: string) => void, 
  changeTask: (task: any, taskId: string, listId: string) => void, 
  deleteTaskFromList: (todolistId: string, taskId: string) => void, 
  reorderedToDoList: (todolistId: string, putAfterItemId: string | null) => void, 
  reorderedTask: (toDoListId: string, taskId: string, putAfterItemId: string | null) => void
}
